(() => {
  ...
  const exact = {
    ...
    'عن CampaignCraft':'ABOUT CAMPAIGNCRAFT','CampaignCraft — منصة ذكية لتخطيط الحملات الرقمية':'CampaignCraft — Smart Digital Campaign Planning Platform','منصة ويب تساعد الأفراد والفرق على تحويل فكرة الحملة إلى خطة قابلة للتنفيذ، بدءًا من تحديد الهدف والجمهور واختيار القنوات، مرورًا بصناعة المحتوى والجدولة، وصولًا إلى بناء الاستبيانات وقياس النتائج وتحسين الأداء.':'A web platform that helps individuals and teams turn a campaign idea into an actionable plan—from defining objectives and audiences and selecting channels, to content planning and scheduling, survey creation, performance measurement, and optimization.','التفكير الاستراتيجي':'Strategic Thinking','تخطيط المحتوى':'Content Planning','التحليلات الرقمية':'Digital Analytics','يربط هدف الحملة بالجمهور، القناة، الرسالة، ومرحلة مسار التحويل.':'Connects the campaign objective with the audience, channel, message, and funnel stage.','ينشئ أفكارًا قابلة للتصوير والنشر مع صيغة ووقت وكابشن وCTA.':'Creates production-ready content ideas with format, timing, captions, and CTAs.','يقترح مؤشرات قياس وخطة تحسين بدل الاكتفاء بالأفكار الإبداعية.':'Recommends performance metrics and an optimization plan—not just creative ideas.',
    ...
    'مشاركة الاستبيان':'Share survey','رابط الاستبيان جاهز':'Survey link is ready','استخدمي «مشاركة الرابط» لإرساله مباشرة، ومن نافذة المشاركة يمكنك أيضًا اختيار «نسخ».':'Use “Share link” to send it directly. You can also choose “Copy” from the share sheet.','مشاركة الرابط':'Share link','نسخ الرابط':'Copy link','فتح الاستبيان':'Open survey','أين تظهر الإجابات؟':'Where do the responses appear?','ادخلي إلى تبويب':'Go to the','الإجابات والتحليل':'Responses & analysis','ستظهر الردود والإحصاءات هناك تلقائيًا، ولا يستطيع مشاهدتها إلا صاحب الاستبيان.':'Responses and analytics appear there automatically and are visible only to the survey owner.','عرض الإجابات':'View responses','خيارات متقدمة':'Advanced options','تصدير الاستبيان JSON':'Export survey JSON','استيراد إجابات':'Import responses','نسخ كود التضمين':'Copy embed code','فحص جودة الاستبيان':'Survey quality check','عرض التحليل ←':'View analysis →','إجابات الاستبيان ستظهر هنا':'Survey responses will appear here','شاركي الرابط مع المشاركين، ثم عودي إلى هذا التبويب. يتم جلب الردود تلقائيًا من قاعدة البيانات، ولا يراها إلا صاحب الاستبيان.':'Share the link with participants, then return to this tab. Responses are loaded automatically from the database and are visible only to the survey owner.',
